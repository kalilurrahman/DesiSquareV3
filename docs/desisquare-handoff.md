...
| Doc | Path |
|---|---|
| **User stories v3 — 115 stories / 20 epics / 7 personas**, G/W/T, P0–P2, Discourse plugin mappings | `docs/desisquare-user-stories.md` |
